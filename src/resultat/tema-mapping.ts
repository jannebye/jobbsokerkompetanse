...
const temaLogikk = {
    ...
    'soknadCV2': {
        alternativ: [ '1007', 'soke-svar-0101', 'soke-svar-0201', 'soke-svar-0401' ],
    ...
    'intervju2': {
        alternativ: [ 'soke-svar-0101', 'soke-svar-0201', 'intervju-svar-0101',
            'intervju-svar-0102', 'intervju-svar-0201', 'intervju-svar-0202', 'intervju-svar-0301' ],
        handling: typeHandling.VIS
    },
    'intervju3': {
        alternativ: [ 'soke-svar-0101', 'soke-svar-0201' ],
    ...
    'intervju5': {
        alternativ: [ 'soke-svar-0101', 'soke-svar-0102', 'intervju-svar-0101', 'intervju-svar-0102',
            'intervju-svar-0201', 'intervju-svar-0202', 'intervju-svar-0301' ],
        handling: typeHandling.VIS
    },
    'intervju6': {
    ...
    'intervju7': {
        alternativ: [ 'soke-svar-0101', 'soke-svar-0102', 'intervju-svar-0201',
            'intervju-svar-0202', 'intervju-svar-0301' ],
        handling: typeHandling.VIS
    },
    'intervju8': {
    ...
    'begynnSelv1': {
        alternativ: [ 'soke-svar-0101', 'intervju-svar-0501', 'intervju-svar-0502' ],
        handling: typeHandling.VIS
    },
    'begynnSelv4': {
    ...
    'begynnSelv12': {
        alternativ: [ 'finn-svar-0203', 'finn-svar-0204', 'finn-svar-0205', 'finn-svar-0206', 'intervju-svar-0406' ],
        handling: typeHandling.SKJUL
    },
    'begynnSelv13': {
        alternativ: [ 'finn-svar-0302', 'cv-svar-0403', 'cv-svar-0404', 'cv-svar-0405' ],
        handling: typeHandling.SKJUL
    },
