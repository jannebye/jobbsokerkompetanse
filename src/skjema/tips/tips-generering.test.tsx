...
describe('TipsGenerator', () => {
    ...
    it('skal foreslå å tilpasse søknad og CV dersom man ikke gjør det og søker på forskjellige typer stilling', () => {
        ...
        const besvarelse = [
            ...
            },
            {
                ...
                svarAlternativer: [{ id: 'finn-svar-0302' }],
                tips: undefined
            }
        ];
        const tips = visTipsEtterSporsmal(spmId, besvarelse);
    ...
    it('skal ikke foreslå å tilpasse søknad og CV dersom man ikke gjør det men søker på kun en type stilling', () => {
        ...
        const besvarelse = [
            ...
            {
                sporsmalId: 'finn-spm-03',
                svarAlternativer: [{ id: 'finn-svar-0301' }],
                tips: undefined
            }
        ];
        const tips = visTipsEtterSporsmal(spmId, besvarelse);
        ...
        () => {
            ...
            const besvarelse = [
                ...
                },
                {
                    ...
                    svarAlternativer: [{ id: 'soke-svar-0104' }],
                    tips: undefined
                }
            ];
            const tips = visTipsEtterSporsmal(spmId, besvarelse);
    ...
    it(
        ...
        () => {
            ...
            const besvarelse = [
                ...
                {
                    sporsmalId: 'soke-spm-01',
                    svarAlternativer: [{ id: 'soke-svar-0105' }],
                    tips: undefined
                }
            ];
            const tips = visTipsEtterSporsmal(spmId, besvarelse);
        ...
        () => {
            ...
            const besvarelse = [
                ...
                },
                {
                    ...
                    svarAlternativer: [{ id: 'soke-svar-0203' }],
                    tips: undefined
                }
            ];
            const tips = visTipsEtterSporsmal(spmId, besvarelse);
    ...
    it(
        ...
        () => {
            ...
            const besvarelse = [
                ...
                {
                    sporsmalId: 'soke-spm-02',
                    svarAlternativer: [{ id: 'soke-svar-0201' }],
                    tips: undefined
                }
            ];
            const tips = visTipsEtterSporsmal(spmId, besvarelse);
    ...
    it(
        ...
        () => {
            ...
            const besvarelse = [
                ...
                {
                    sporsmalId: 'intervju-spm-02',
                    svarAlternativer: [{ id: 'intervju-svar-0201' }],
                    tips: undefined
                },
                {
                    sporsmalId: 'intervju-spm-01',
                    svarAlternativer: [{ id: 'intervju-svar-0101' }],
                    tips: undefined
                }
            ];
            const tips = visTipsEtterSporsmal(spmId, besvarelse);
